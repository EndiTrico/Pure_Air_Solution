...
function adminDashboardProperties($activity)
{
    include 'database/config.php';
    include 'database/opendb.php';
    ...
    if ($activity == "Pending") {
        $sql = "SELECT COUNT(*)
                FROM FATTURE
                WHERE E_PAGATO = 0 AND DATA_SCADENZA >= CURDATE()";
        ...
        $sql = "SELECT COUNT(*)
                FROM IMPIANTI
                WHERE E_ATTIVO = 1 AND DATA_ULTIMA_ATT >= DATE_SUB(CURDATE(), INTERVAL 1 MONTH)";
    }
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-6 d-flex justify-content-center">
                                            <div class="card-header">
                                                <br><br>
                                                <h1 class="welcome-msg" style="margin-top: 80px">Amministratore</h1>
                                        ...
                                        <div class="col-12 col-md-6 col-lg-3 text-center text-md-left">
                                            <div class="containercount mx-auto"
                                                ...
                                                <i class="fa-solid fa-hourglass-half"></i>                                                <span class="num"
                                                    data-val="<?php echo adminDashboardProperties('Pending'); ?>"></span>
                                        ...
                                        <div class="col-12 col-md-6 col-lg-3 text-center text-md-left">
                                            <div class="containercount mx-auto"
                                                ...
                                                <span class="num"
                                                    data-val="<?php echo adminDashboardProperties('Unpaid'); ?>"></span>
                                                <div class="text-wrapper">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-3 text-center text-md-left">
                                            <div class="containercount mx-auto"
                                                ...
                                                <span class="num"
                                                    data-val="<?php echo adminDashboardProperties('Company'); ?>"></span>
                                                <div class="text-wrapper">
                                        ...
                                        <div class="col-12 col-md-6 col-lg-3 text-center text-md-left">
                                            <div class="containercount mx-auto"
                                                style="background: linear-gradient(235deg, rgba(9,108,227,1) 21%, rgba(120,155,209,1) 65%);">                                                <i class="fa-solid fa-circle-check"></i>
                                                <span class="num"
                                                    data-val="<?php echo adminDashboardProperties('Impianti'); ?>"></span>
                                                <div class="text-wrapper">
