                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        ...
                                                        <div class="mb-3 row d-flex justify-content-center">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <input type="number" class="form-control" id="value" oninput="calculateValueWithVAT()" name="bill_value" placeholder="Valore" min=0 max=100000000000000000000000000 step="any" required>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="mb-3 row d-flex justify-content-center">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <input type="number" class="form-control" id="VAT" oninput="calculateValueWithVAT()" name="bill_VAT" placeholder="IVA" min="0" max="100" step="any" value="0" required>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="mb-3 row d-flex justify-content-center">
                                                            <h5 class="card-title col-sm-2 col-form-label">Valore Iva
                                                                Inclusa</h5>
                                                            <div class="col-sm-4">
                                                                <input type="number" class="form-control" id="bill_withVAT" name="bill_withVAT" placeholder="Valore Iva Inclusa" min=0 value="0" max=100000000000000000000000000 step="any" readonly>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="mb-3 row d-flex justify-content-center">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <input readonly type="text" class="form-control" id="datePicker" name="bill_payment_date" placeholder="Data di Pagamento" style="background: url('data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 24 24%22 fill=%22none%22 stroke=%22currentColor%22 stroke-width=%222%22 stroke-linecap=%22round%22 stroke-linejoin=%22round%22%3E%3Crect x=%223%22 y=%224%22 width=%2218%22 height=%2218%22 rx=%222%22 ry=%222%22/%3E%3Cline x1=%2216%22 y1=%222%22 x2=%2216%22 y2=%226%22/%3E%3Cline x1=%228%22 y1=%222%22 x2=%228%22 y2=%226%22/%3E%3Cline x1=%223%22 y1=%2210%22 x2=%2221%22 y2=%2210%22/%3E%3C/svg%3E') no-repeat right 10px center; background-size: 16px; background-color: white">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="mb-3 row d-flex justify-content-center">
                                                            ...
                                                            <div class="col-sm-4">
                                                                <textarea class="form-control" name="bill_information" rows="3" placeholder="Descrizione"></textarea>
                                                            </div>
                                                        </div>

                                                        <div class="row">
                                                            <div class="col-12 d-flex justify-content-center">
                                                                <button name="create_bill" id="createBillButton" class="btn btn-success btn-lg">Crea una
                                                                    Fattura</button>
                                                            </div>
                                                        </div>
                                                    </div>
