                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-lg-6">
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body">
                                                                <input type="number" class="form-control" id="bill_withVAT" name="bill_withVAT" placeholder="Valore Iva Inclusa" min=0 max=100000000000000000000000000 step="any" readonly>
                                                            </div>
                                                        </div>
                                                        <div class="card">
                                                            <div class="card-header">
                                                            ...
                                                            <div class="card-body">
                                                                <input type="number" class="form-control" id="VAT" oninput="calculateValueWithVAT()" name="bill_VAT" placeholder="IVA" min="0" max="100" step="any" required>
                                                            </div>
                                                        </div>
                                                        <div class="card">
                                                            <div class="card-header">
