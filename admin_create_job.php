...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['create_job'])) {
        ...
        mysqli_stmt_bind_param($stmt, "sssi", $job_construction, $job_data, $job_information, $_SESSION["user_id"]);
                        ...
                        <div class="col-auto">
                            <?php
                                if ($_SESSION["role"] == "Admin") {
                                    echo '<a class="btn transparent-btn" style="margin-top: -7px;" href="admin_create.php">
                                        ...
                                        <div class="row">
                                            <div class="col-12 d-flex justify-content-center">
                                                <button type="submit" name="create_job"
                                                    class="btn btn-success btn-lg">Crea
                                                </button>
                                            </div>
                                        </div>
                                    </form>
