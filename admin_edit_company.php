        ...
        <div class="row">
            <div class="col-12">
                <div class="mb-3 row d-flex justify-content-center">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="company_name" placeholder="Nome"  value="' . $row['AZIENDA_NOME'] . '" required>
                    </div>
                </div>
                ...
                <div class="mb-3 row d-flex justify-content-center">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="company_nipt" placeholder="Partita Iva" value="' . $row['PARTITA_IVA'] . '" required>
                    </div>
                </div>
                ...
                <div class="mb-3 row d-flex justify-content-center">
                    ...
                    <div class="col-sm-4">
                        <input type="email" class="form-control" name="company_address_pec" value="' . $row['INDIRIZZO_PEC'] . '" placeholder="Indirizzo"
                            required>
                    </div>
                </div>
                ...
                <div class="mb-3 row d-flex justify-content-center">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="company_address" value="' . $row['INDIRIZZO'] . '" placeholder="Indirizzo">
                    </div>
                </div>
                ...
                <div class="mb-3 row d-flex justify-content-center">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="company_city" value="' . $row['CITTA'] . '" placeholder="Citta">
                    </div>
                </div>
                ...
                <div class="mb-3 row d-flex justify-content-center">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="company_contact1" value="' . $row['CONTATTO_1'] . '" placeholder="Contatto 1">
                    </div>
                </div>
                ...
                <div class="mb-3 row d-flex justify-content-center">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="company_contact2" value="' . $row['CONTATTO_2'] . '" placeholder="Contatto 2">
                    </div>
                </div>
                ...
                <div class="mb-3 row d-flex justify-content-center">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="company_contact3" value="' . $row['CONTATTO_3'] . '" placeholder="Contatto 3">
                    </div>
                </div>
                ...
                <div class="mb-3 row d-flex justify-content-center">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="company_email1" placeholder="Email 1" 
            ...
            <input readonly type="text" class="form-control" id="datePicker"
                ...
                <div class="row">
                    <div class="col-12 d-flex justify-content-center">
                        <button name="update_company" id="updateUserButton" class="btn btn-success btn-lg">Aggiorna
                            l\'Azienda</button>
                    </div>
                </div>
            </div>
