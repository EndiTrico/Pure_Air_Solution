...
<form id="structureForm" method="post">
        <div class="row" style="background:url(\'./images/logo/logo01_backgroundForm.png\'); background-color: white;  background-size: contain; background-position: center; background-repeat: no-repeat; ">
            ...
            <div class="mb-3 row d-flex justify-content-center">
                ...
                <div class="col-sm-4">
                    <input disabled type="text" class="form-control" name="structure_name" placeholder="Nome" required value="' . $row['STRUTTURA_NOME'] . '">
                </div>
            </div>
            ...
            <div class="mb-3 row d-flex justify-content-center">
                ...
                <div class="col-sm-4">
                    <input disabled type="text" class="form-control" name="structure_address" placeholder="Indirizzo" value="' . $row['INDIRIZZO'] . '">
                </div>
            </div>
            ...
            <div class="mb-3 row row d-flex justify-content-center">
                ...
                <div class="col-sm-4">
                    <input disabled type="text" class="form-control" name="structure_city" placeholder="Citta" value="' . $row['CITTA'] . '">
                </div>
            </div>
        ...
        <div class="col-sm-4">
            <input disabled readonly type="text" class="form-control" id="datePicker"
                name="structure_joined_date" placeholder="Data di Inizio" required value = "' . $row['DATA_INIZIO'] . '"
    ...
    <div class="mb-3 row d-flex justify-content-center">
        ...
        <div class="col-sm-4">
            <input disabled readonly type="text" class="form-control" id="datePicker"
                name="structure_left_date" placeholder="Data di Fine" value = "' . $row['DATA_FINE'] . '"
                style="background: #E9ECEF url(\'data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 24 24%22 fill=%22none%22 stroke=%22currentColor%22 stroke-width=%222%22 stroke-linecap=%22round%22 stroke-linejoin=%22round%22%3E%3Crect x=%223%22 y=%224%22 width=%2218%22 height=%2218%22 rx=%222%22 ry=%222%22/%3E%3Cline x1=%2216%22 y1=%222%22 x2=%2216%22 y2=%226%22/%3E%3Cline x1=%228%22 y1=%222%22 x2=%228%22 y2=%226%22/%3E%3Cline x1=%223%22 y1=%2210%22 x2=%2221%22 y2=%2210%22/%3E%3C/svg%3E\') no-repeat right 10px center; background-size: 16px;">
        </div>
    </div>
            ...
            <div class="mb-3 row d-flex justify-content-center">
                ...
                <div class="col-sm-4">
                    <textarea disabled class="form-control" name="structure_information" rows="3" placeholder="Informazioni">' . $row["INFORMAZIONI"] . '</textarea>
                </div>
            </div>
        <div class="mb-3 row d-flex justify-content-center">
