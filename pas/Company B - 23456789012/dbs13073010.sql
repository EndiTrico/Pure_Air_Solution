...
--
-- Host: db5016048755.hosting-data.io
-- Generation Time: Aug 15, 2024 at 10:05 AM
...
CREATE TABLE `AZIENDE` (
  ...
  `AZIENDA_NOME` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `PARTITA_IVA` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `CODICE_FISCALE` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `CONTATTO_1` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `CONTATTO_2` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `CONTATTO_3` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `EMAIL_1` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `EMAIL_2` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `EMAIL_3` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `TELEFONO_1` bigint DEFAULT NULL,
  `TELEFONO_2` bigint DEFAULT NULL,
  `TELEFONO_3` bigint DEFAULT NULL,
  `INDIRIZZO` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `CITTA` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `INDIRIZZO_PEC` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `DATA_INIZIO` date DEFAULT NULL,
  `DATA_FINE` date DEFAULT NULL,
  `WEBSITE` varchar(2555) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `INFORMAZIONI` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `BANCA_CONTI` (
  `BANCA_CONTO_ID` bigint NOT NULL,
  `AZIENDA_ID` bigint NOT NULL,
  `BANCA_NOME` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `DOCUMENTI` (
  ...
  `IMPIANTO_ID` bigint NOT NULL,
  `NOME` varchar(1024) COLLATE utf8mb4_general_ci NOT NULL,
  `PERCORSO` varchar(3072) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `DOCUMENTI` (`DOCUMENTO_ID`, `IMPIANTO_ID`, `NOME`, `PERCORSO`, `DATA_CARICAMENTO`, `DATA_CANCELLATA`, `E_ATTIVO`) VALUES
(3, 1, '', './raw/LOMA/Supplies4medics_Presantation.pdf', '2024-07-18 00:00:00', NULL, b'0'),
(4, 1, 'Invoice-AD2B0D35-0005.pdf', 'files/Invoice-AD2B0D35-0005.pdf', '2024-07-28 12:07:26', NULL, b'1'),
(5, 1, 'n.png', 'files/n.png', '2024-07-28 12:13:18', NULL, b'1'),
(6, 1, 'add_file.png', 'files/shqip/add_file.png', '2024-07-28 13:31:54', '2024-07-28 18:19:10', b'0'),
(7, 1, 'remove.png', 'files/remove.png', '2024-07-28 17:43:48', '2024-08-03 14:00:55', b'0'),
(8, 1, 'delete_file.png', 'files/delete_file.png', '2024-07-28 17:48:43', '2024-07-28 17:48:54', b'0'),
(9, 1, 'FA_109993144714.pdf', 'files/shqip/FA_109993144714.pdf', '2024-07-28 18:20:10', '2024-07-28 18:20:59', b'0'),
(10, 1, 'NAM SP24 Project Work.pdf', 'files/NAM SP24 Project Work.pdf', '2024-07-28 18:26:18', NULL, b'1'),
(11, 2, 'small_logo.png', 'files/breshka/small_logo.png', '2024-08-03 13:52:48', NULL, b'1'),
(12, 2, 'Answer.html', 'files/Answer.html', '2024-08-03 18:06:50', '2024-08-03 20:28:53', b'0'),
(13, 2, 'RickAndMortyScripts.csv', 'files/RickAndMortyScripts.csv', '2024-08-03 20:33:21', NULL, b'1');
...
CREATE TABLE `FATTURE` (
  ...
  `AZIENDA_ID` bigint NOT NULL,
  `BANCA_CONTO_ID` bigint DEFAULT NULL,
  `FATTURA_NOME` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `VALORE` decimal(20,2) DEFAULT NULL,
  `VALORE_IVA_INCLUSA` decimal(20,2) DEFAULT NULL,
  `IVA` decimal(20,2) DEFAULT NULL,
  `MONETA` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(4, 4, NULL, NULL, '2500.00', '3000.00', '500.00', '1', '2023-04-15', NULL, NULL, 'Product D', b'0'),
...
CREATE TABLE `IMPIANTI` (
  `IMPIANTO_ID` bigint NOT NULL,
  `AZIENDA_ID` bigint NOT NULL,
  `STRUTTURA_ID` bigint NOT NULL,
  `REPARTO_ID` bigint NOT NULL,
  `IMPIANTO_NOME` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `ULTIMA_ATTIVITA` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `DATA_INIZIO` date DEFAULT NULL,
  `DATA_FINE` date DEFAULT NULL,
...
CREATE TABLE `LOGS` (
  ...
  `ENTITA` varchar(140) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `ENTITA_ID` bigint DEFAULT NULL,
  `AZIONE` varchar(140) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `UA_AZIENDA_ID` bigint DEFAULT NULL,
  `UA_UTENTE_ID` bigint DEFAULT NULL,
  `ATTRIBUTO` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `VECCHIO_VALORE` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `NUOVO_VALORE` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
...
CREATE TABLE `REPARTI` (
  ...
  `AZIENDA_ID` bigint NOT NULL,
  `STRUTTURA_ID` bigint NOT NULL,
  `REPARTO_NOME` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `INDIRIZZO` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `CITTA` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `DATA_INIZIO` date DEFAULT NULL,
  `DATA_FINE` date DEFAULT NULL,
...
CREATE TABLE `STRUTTURE` (
  `STRUTTURA_ID` bigint NOT NULL,
  `AZIENDA_ID` bigint NOT NULL,
  `STRUTTURA_NOME` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `INDIRIZZO` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `CITTA` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `DATA_INIZIO` date DEFAULT NULL,
  `DATA_FINE` date DEFAULT NULL,
...
CREATE TABLE `UTENTI` (
  ...
  `AZIENDA_POSIZIONE` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
ALTER TABLE `DOCUMENTI`
  ...
  ADD KEY `FK_IMPIANTI_DOCUMENTI` (`IMPIANTO_ID`);
...
--
ALTER TABLE `AZIENDE`
  MODIFY `AZIENDA_ID` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `BANCA_CONTI`
--
ALTER TABLE `BANCA_CONTI`
  MODIFY `BANCA_CONTO_ID` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `DOCUMENTI`
--
ALTER TABLE `DOCUMENTI`
  MODIFY `DOCUMENTO_ID` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `FATTURE`
--
ALTER TABLE `FATTURE`
  MODIFY `FATTURA_ID` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `IMPIANTI`
--
ALTER TABLE `IMPIANTI`
  MODIFY `IMPIANTO_ID` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `LOGS`
--
ALTER TABLE `LOGS`
  MODIFY `LOG_ID` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=421;

--
-- AUTO_INCREMENT for table `REPARTI`
--
ALTER TABLE `REPARTI`
  MODIFY `REPARTO_ID` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `STRUTTURE`
--
ALTER TABLE `STRUTTURE`
  MODIFY `STRUTTURA_ID` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT for table `UTENTI`
--
ALTER TABLE `UTENTI`
  MODIFY `UTENTE_ID` bigint NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
...
--
ALTER TABLE `DOCUMENTI`
  ADD CONSTRAINT `FK_IMPIANTI_DOCUMENTI` FOREIGN KEY (`IMPIANTO_ID`) REFERENCES `IMPIANTI` (`IMPIANTO_ID`);
