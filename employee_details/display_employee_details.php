        ...
        <div class="row">
            <div class="col-12">
                <div class="mb-1 row d-flex justify-content-center">
                    <h5 class="card-title col-sm-4 col-form-label text-end">Nome</h5>
                    <div class="col-sm-4">
                ...
                <div class="mb-1 row d-flex justify-content-center">
                    <h5 class="card-title col-sm-4 col-form-label text-end">Cognome
                        Iva</h5>
                    <div class="col-sm-4">
                ...
                <div class="mb-1 row d-flex justify-content-center">
                    <h5 class="card-title col-sm-4 col-form-label text-end">Email</h5>
                    <div class="col-sm-4">
                ...
                <div class="mb-1 row d-flex justify-content-center">
                    <h5 class="card-title col-sm-4 col-form-label text-end">Data di Nascita</h5>
                    <div class="col-sm-4">
                ...
                <div class="mb-1 row d-flex justify-content-center">
                    <h5 class="card-title col-sm-4 col-form-label text-end">Codice Fiscale</h5>
                    <div class="col-sm-4">
                ...
                <div class="mb-1 row d-flex justify-content-center">
                    <h5 class="card-title col-sm-4 col-form-label text-end">Indirizzo</h5>
                    <div class="col-sm-4">
                ...
                <div class="mb-1 row d-flex justify-content-center">
                    <h5 class="card-title col-sm-4 col-form-label text-end">Ruolo</h5>
                    <div class="col-sm-4">
                ...
                <div class="mb-1 row d-flex justify-content-center">
                    <h5 class="card-title col-sm-4 col-form-label text-end">Ragione Sociale</h5>
                    <div class="col-sm-4">
                ...
                <div class="mb-1 row d-flex justify-content-center">
                    <h5 class="card-title col-sm-4 col-form-label text-end">PIVA</h5>
                    <div class="col-sm-4">
                ...
                <div class="mb-1 row d-flex justify-content-center">
                    <h5 class="card-title col-sm-4 col-form-label text-end">Telefono</h5>
                    <div class="col-sm-4">
                ...
                <div class="mb-1 row d-flex justify-content-center">
                    <h5 class="card-title col-sm-4 col-form-label text-end">Matricola</h5>
                    <div class="col-sm-4">
                        <input disabled type="number" class="form-control" name="employee_matricola" placeholder="Matricola" value="' . $row['MATRICOLA'] . '">
                    </div>
                </div>
                <div class="mb-1 row d-flex justify-content-center">
                    <h5 class="card-title col-sm-4 col-form-label text-end">Qualifica</h5>
                    <div class="col-sm-4">
                ...
                <div class="mb-1 row d-flex justify-content-center">
                    <h5 class="card-title col-sm-4 col-form-label text-end">Mansione</h5>
                    <div class="col-sm-4">
                ...
                <div class="mb-1 row d-flex justify-content-center">
                    <h5 class="card-title col-sm-4 col-form-label text-end">Contratto</h5>
                    <div class="col-sm-4">
                ...
                <div class="mb-1 row d-flex justify-content-center">
                    <h5 class="card-title col-sm-4 col-form-label text-end">Assunto Il</h5>
                    <div class="col-sm-4">
                        <input disabled readonly type="text" class="form-control" id="datePicker"
                ...
                <div class="mb-1 row d-flex justify-content-center">
					<h5 class="card-title col-sm-4 col-form-label text-end">Data di Fine</h5>
					<div class="col-sm-4">
						<input disabled readonly type="text" class="form-control" id="datePicker"
                ...
                <div class="mb-1 row d-flex justify-content-center">
                    <h5 class="card-title col-sm-4 col-form-label text-end">Visita Medica Idoneita</h5>
                    <div class="col-sm-4">
                   		<input disabled readonly type="text" class="form-control" id="datePicker"
                ...
                <div class="mb-1 row d-flex justify-content-center">
                    <h5 class="card-title col-sm-4 col-form-label text-end">Ricevuta Cosegna DPI</h5>
                    <div class="col-sm-4">
                    	<input disabled readonly type="text" class="form-control" id="datePicker"
                ...
                <div class="mb-1 row d-flex justify-content-center">
                    <h5 class="card-title col-sm-4 col-form-label text-end">Attestato Formazione Specifica</h5>
                    <div class="col-sm-4">
                    	<input disabled readonly type="text" class="form-control" id="datePicker"
                ...
                <div class="mb-1 row d-flex justify-content-center">
                    <h5 class="card-title col-sm-4 col-form-label text-end">Corso Formazione Informazione Base</h5>
                    <div class="col-sm-4">
                    	<input disabled readonly type="text" class="form-control" id="datePicker"
                ...
                <div class="mb-1 row d-flex justify-content-center">
                    <h5 class="card-title col-sm-4 col-form-label text-end">Corso Utilizzo DPI CAT3</h5>
                    <div class="col-sm-4">
                        <input disabled readonly type="text" class="form-control" id="datePicker"
				...
				<div class="mb-1 row d-flex justify-content-center">
					<h5 class="card-title col-sm-4 col-form-label text-end">E Attivo</h5>
					<div class="col-sm-4">
